...
//     fn update_candidates(ref self: T, new_candidates: Array<felt252>); // Owner updates
//     candidates
...
//             assert(candidate_id < self.total_candidate_nums.read(), 'Invalid
//             candidate!...Boom!');
...
//     use super::{IZkVotingDispatcher, IZkVotingDispatcherTrait};
//     use super:: ElectionStages;
